...
namespace Steganography
{
	...
	{
		/// <summary>
		/// Constructor initialized with the duplicate magic number, the existing type defined for the magic number 
		/// and the type redefining the magic number
		/// </summary>
		/// <param name="magicNumber">Duplicate magic number</param>
