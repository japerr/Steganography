...
namespace Steganography.IO.Implementation
{
	...
	/// </summary>
	public class CarrierClusterStream : Stream, ICarrierClusterStream
	{
		/// <summary>
		/// Logger instance
		/// </summary>
		...
		/// </remarks>
		public void Initialize(IKeySequence keySequence, IEnumerable<ICarrierStream> carrierStreams)
		{
